...
// OK Google Docs spreadsheet key OK
var spreadsheet_key = '1RBXvfL8A5OWKVShefgjkAlbikwnakpBzytz9fccuPzI';

// OK Name of lat, long columns in Google spreadsheet
...
function generatePopup(content){
	...
	popup_content += '<tr><td><strong>Name_1:</strong></td>';
	popup_content += '<td>' + content['address'] + '</td>';
	popup_content += '<tr><td><strong>Name_2:</strong></td>';
	popup_content += '<td>' + content['city'] + '</td>';
	popup_content += '<tr><td><strong>Name_3:</strong></td>';
